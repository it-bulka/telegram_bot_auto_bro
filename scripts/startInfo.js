const { SITE_URL_TEXT, SITE_URL} = require('./consts/consts')
/**
...
Просто відправте мені ссилку на авто, з сайту 🔗[${SITE_URL_TEXT}](${SITE_URL}), і я розрахую вам кнцеву вартість автомобіля з врахуванням абсолютно усіх витрат до Києва.✅
